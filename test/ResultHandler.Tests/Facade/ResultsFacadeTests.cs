...
public class ResultsFacadeTests
{
    ...
    {
        var result = ResultHandler.Facade.Results.Success();
    ...
    {
        var result = ResultHandler.Facade.Results.Success(42);
    ...
    {
        var result = ResultHandler.Facade.Results.MovedPermanently("https://example.com/new");
    ...
    {
        var result = ResultHandler.Facade.Results.NotFound("The user does not exist.");
    ...
    {
        var result = ResultHandler.Facade.Results.Unauthorized();
    ...
    {
        var result = ResultHandler.Facade.Results.NotFound<string>("Missing.");
    ...
    {
        var result = ResultHandler.Facade.Results.Invalid("Name is required.", "Email is invalid.");
    ...
    public void Invalid_ReadOnlyListOverload_SetsErrors()
    {
        ...
        var result = ResultHandler.Facade.Results.Invalid(errors);
    ...
    {
        var result = ResultHandler.Facade.Results.Failure("Custom title", "Custom detail", ResultStatus.Conflict);
    ...
    {
        var result = ResultHandler.Facade.Results.Failure(-1, "Custom title", "Custom detail", ResultStatus.Conflict);
